  ...
  const response = await page.request.post("/api/platform/studio/blocks", {
    data: {
      block: {
        ...
        editableFields: ["name"],
        actions: [],
        previewHtml: "<section><h1>Naming Block</h1></section>",
        sourcePreviewHtml: "<section><h1>Naming Block</h1></section>",
        targetPreviewHtml: "<section><h1>Naming Block</h1></section>",
        inUseCount: 0,
        usageCount: 0,
